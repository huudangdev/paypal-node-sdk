...
nock('https://api-s.sandbox.paypal.com')
  ...
  .reply(201, {"id":"PAY-4U927911DR058234JKPLKJPQ","create_time":"2014-07-28T19:30:06Z","update_time":"2014-07-28T19:30:24Z","state":"approved","intent":"authorize","payer":{"payment_method":"credit_card","funding_instruments":[{"credit_card":{"type":"visa","number":"xxxxxxxxxxxx0331","expire_month":"11","expire_year":"2018"}}]},"transactions":[{"amount":{"total":"4.00","currency":"USD","details":{"subtotal":"4.00"}},"related_resources":[{"authorization":{"id":"0RK65467EA345342V","create_time":"2014-07-28T19:30:06Z","update_time":"2014-07-28T19:30:24Z","amount":{"total":"4.00","currency":"USD","details":{"subtotal":"4.00"}},"state":"authorized","parent_payment":"PAY-4U927911DR058234JKPLKJPQ","valid_until":"2014-08-26T19:30:06Z","links":[{"href":"https://api-s.sandbox.paypal.com/v1/payments/authorization/0RK65467EA345342V","rel":"self","method":"GET"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/authorization/0RK65467EA345342V/capture","rel":"capture","method":"POST"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/authorization/0RK65467EA345342V/void","rel":"void","method":"POST"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/payment/PAY-4U927911DR058234JKPLKJPQ","rel":"parent_payment","method":"GET"}]}}]}],"links":[{"href":"https://api-s.sandbox.paypal.com/v1/payments/payment/PAY-4U927911DR058234JKPLKJPQ","rel":"self","method":"GET"}]}, { server: 'Apache-Coyote/1.1',
  proxy_server_info: 'host=slcsbjava2.slc.paypal.com;threadId=80979',
...
nock('https://api-s.sandbox.paypal.com')
  .post('/v1/payments/payment/', {"intent":"authorize","payer":{"payment_method":"credit_card","funding_instruments":[{"credit_card":{"type":"visa","number":"4417119669820331","expire_month":"11","expire_year":"2018"}}]},"transactions":[{"amount":{"total":"4.00","currency":"USD"}}]})
  .reply(201, {"id":"PAY-9X793799D49897052KPLKJUQ","create_time":"2014-07-28T19:30:26Z","update_time":"2014-07-28T19:30:45Z","state":"approved","intent":"authorize","payer":{"payment_method":"credit_card","funding_instruments":[{"credit_card":{"type":"visa","number":"xxxxxxxxxxxx0331","expire_month":"11","expire_year":"2018"}}]},"transactions":[{"amount":{"total":"4.00","currency":"USD","details":{"subtotal":"4.00"}},"related_resources":[{"authorization":{"id":"8DX776641K0970446","create_time":"2014-07-28T19:30:26Z","update_time":"2014-07-28T19:30:45Z","amount":{"total":"4.00","currency":"USD","details":{"subtotal":"4.00"}},"state":"authorized","parent_payment":"PAY-9X793799D49897052KPLKJUQ","valid_until":"2014-08-26T19:30:26Z","links":[{"href":"https://api-s.sandbox.paypal.com/v1/payments/authorization/8DX776641K0970446","rel":"self","method":"GET"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/authorization/8DX776641K0970446/capture","rel":"capture","method":"POST"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/authorization/8DX776641K0970446/void","rel":"void","method":"POST"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/payment/PAY-9X793799D49897052KPLKJUQ","rel":"parent_payment","method":"GET"}]}}]}],"links":[{"href":"https://api-s.sandbox.paypal.com/v1/payments/payment/PAY-9X793799D49897052KPLKJUQ","rel":"self","method":"GET"}]}, { server: 'Apache-Coyote/1.1',
  proxy_server_info: 'host=slcsbjava3.slc.paypal.com;threadId=291',
...
nock('https://api-s.sandbox.paypal.com')
  ...
  .reply(200, {"id":"48J29121JK794832A","create_time":"2014-07-28T19:30:45Z","update_time":"2014-07-28T19:31:03Z","amount":{"total":"4.00","currency":"USD"},"is_final_capture":false,"state":"completed","parent_payment":"PAY-9X793799D49897052KPLKJUQ","links":[{"href":"https://api-s.sandbox.paypal.com/v1/payments/capture/48J29121JK794832A","rel":"self","method":"GET"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/capture/48J29121JK794832A/refund","rel":"refund","method":"POST"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/authorization/8DX776641K0970446","rel":"authorization","method":"GET"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/payment/PAY-9X793799D49897052KPLKJUQ","rel":"parent_payment","method":"GET"}]}, { server: 'Apache-Coyote/1.1',
...
nock('https://api-s.sandbox.paypal.com')
  .post('/v1/payments/payment/', {"intent":"authorize","payer":{"payment_method":"credit_card","funding_instruments":[{"credit_card":{"type":"visa","number":"4417119669820331","expire_month":"11","expire_year":"2018"}}]},"transactions":[{"amount":{"total":"4.00","currency":"USD"}}]})
  .reply(201, {"id":"PAY-5PE52817A5045184DKPLKJ6A","create_time":"2014-07-28T19:31:04Z","update_time":"2014-07-28T19:31:22Z","state":"approved","intent":"authorize","payer":{"payment_method":"credit_card","funding_instruments":[{"credit_card":{"type":"visa","number":"xxxxxxxxxxxx0331","expire_month":"11","expire_year":"2018"}}]},"transactions":[{"amount":{"total":"4.00","currency":"USD","details":{"subtotal":"4.00"}},"related_resources":[{"authorization":{"id":"0MM900359B6381213","create_time":"2014-07-28T19:31:04Z","update_time":"2014-07-28T19:31:22Z","amount":{"total":"4.00","currency":"USD","details":{"subtotal":"4.00"}},"state":"authorized","parent_payment":"PAY-5PE52817A5045184DKPLKJ6A","valid_until":"2014-08-26T19:31:04Z","links":[{"href":"https://api-s.sandbox.paypal.com/v1/payments/authorization/0MM900359B6381213","rel":"self","method":"GET"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/authorization/0MM900359B6381213/capture","rel":"capture","method":"POST"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/authorization/0MM900359B6381213/void","rel":"void","method":"POST"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/payment/PAY-5PE52817A5045184DKPLKJ6A","rel":"parent_payment","method":"GET"}]}}]}],"links":[{"href":"https://api-s.sandbox.paypal.com/v1/payments/payment/PAY-5PE52817A5045184DKPLKJ6A","rel":"self","method":"GET"}]}, { server: 'Apache-Coyote/1.1',
...
nock('https://api-s.sandbox.paypal.com')
  ...
  .reply(200, {"id":"0MM900359B6381213","create_time":"2014-07-28T19:31:04Z","update_time":"2014-07-28T19:31:22Z","amount":{"total":"4.00","currency":"USD","details":{"subtotal":"4.00"}},"state":"voided","parent_payment":"PAY-5PE52817A5045184DKPLKJ6A","links":[{"href":"https://api-s.sandbox.paypal.com/v1/payments/authorization/0MM900359B6381213","rel":"self","method":"GET"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/payment/PAY-5PE52817A5045184DKPLKJ6A","rel":"parent_payment","method":"GET"}]}, { server: 'Apache-Coyote/1.1',
  proxy_server_info: 'host=slcsbjava3.slc.paypal.com;threadId=288',
...
nock('https://api-s.sandbox.paypal.com')
  .post('/v1/payments/payment/', {"intent":"authorize","payer":{"payment_method":"credit_card","funding_instruments":[{"credit_card":{"type":"visa","number":"4417119669820331","expire_month":"11","expire_year":"2018"}}]},"transactions":[{"amount":{"total":"4.00","currency":"USD"}}]})
  .reply(201, {"id":"PAY-9R239435RW5384224KPLKKDI","create_time":"2014-07-28T19:31:25Z","update_time":"2014-07-28T19:31:43Z","state":"approved","intent":"authorize","payer":{"payment_method":"credit_card","funding_instruments":[{"credit_card":{"type":"visa","number":"xxxxxxxxxxxx0331","expire_month":"11","expire_year":"2018"}}]},"transactions":[{"amount":{"total":"4.00","currency":"USD","details":{"subtotal":"4.00"}},"related_resources":[{"authorization":{"id":"9AL86355RH666682X","create_time":"2014-07-28T19:31:25Z","update_time":"2014-07-28T19:31:43Z","amount":{"total":"4.00","currency":"USD","details":{"subtotal":"4.00"}},"state":"authorized","parent_payment":"PAY-9R239435RW5384224KPLKKDI","valid_until":"2014-08-26T19:31:25Z","links":[{"href":"https://api-s.sandbox.paypal.com/v1/payments/authorization/9AL86355RH666682X","rel":"self","method":"GET"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/authorization/9AL86355RH666682X/capture","rel":"capture","method":"POST"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/authorization/9AL86355RH666682X/void","rel":"void","method":"POST"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/payment/PAY-9R239435RW5384224KPLKKDI","rel":"parent_payment","method":"GET"}]}}]}],"links":[{"href":"https://api-s.sandbox.paypal.com/v1/payments/payment/PAY-9R239435RW5384224KPLKKDI","rel":"self","method":"GET"}]}, { server: 'Apache-Coyote/1.1',
...
nock('https://api-s.sandbox.paypal.com')
  ...
  .reply(200, {"id":"5YP632759C4691005","create_time":"2014-07-28T19:31:44Z","update_time":"2014-07-28T19:32:00Z","amount":{"total":"1.00","currency":"USD"},"is_final_capture":false,"state":"completed","parent_payment":"PAY-9R239435RW5384224KPLKKDI","links":[{"href":"https://api-s.sandbox.paypal.com/v1/payments/capture/5YP632759C4691005","rel":"self","method":"GET"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/capture/5YP632759C4691005/refund","rel":"refund","method":"POST"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/authorization/9AL86355RH666682X","rel":"authorization","method":"GET"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/payment/PAY-9R239435RW5384224KPLKKDI","rel":"parent_payment","method":"GET"}]}, { server: 'Apache-Coyote/1.1',
...
nock('https://api-s.sandbox.paypal.com')
  ...
  .reply(200, {"id":"9AL86355RH666682X","create_time":"2014-07-28T19:31:25Z","update_time":"2014-07-28T19:31:43Z","amount":{"total":"4.00","currency":"USD","details":{"subtotal":"4.00"}},"state":"voided","parent_payment":"PAY-9R239435RW5384224KPLKKDI","links":[{"href":"https://api-s.sandbox.paypal.com/v1/payments/authorization/9AL86355RH666682X","rel":"self","method":"GET"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/payment/PAY-9R239435RW5384224KPLKKDI","rel":"parent_payment","method":"GET"}]}, { server: 'Apache-Coyote/1.1',
  proxy_server_info: 'host=slcsbjava3.slc.paypal.com;threadId=81289',
...
nock('https://api-s.sandbox.paypal.com')
  ...
  .reply(200, {"id":"21S90520JM083611T","create_time":"2014-07-28T19:32:20Z","update_time":"2014-07-28T19:32:37Z","amount":{"total":"1.00","currency":"USD"},"is_final_capture":true,"state":"completed","parent_payment":"PAY-5T6307234B502013SKPLKKMI","links":[{"href":"https://api-s.sandbox.paypal.com/v1/payments/capture/21S90520JM083611T","rel":"self","method":"GET"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/capture/21S90520JM083611T/refund","rel":"refund","method":"POST"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/authorization/2WD80049VF5042042","rel":"authorization","method":"GET"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/payment/PAY-5T6307234B502013SKPLKKMI","rel":"parent_payment","method":"GET"}]}, { server: 'Apache-Coyote/1.1',
  proxy_server_info: 'host=slcsbjava2.slc.paypal.com;threadId=21687',
