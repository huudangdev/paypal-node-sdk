...
nock('https://api-s.sandbox.paypal.com')
  ...
  date: 'Tue, 02 Sep 2014 14:52:57 GMT',
  location: 'https://api-s.sandbox.paypal.com/v1/invoicing/invoices/INV2-E935-Q8M6-DEFW-5R94',
  'content-type': 'application/json',
  'content-length': '1045' });
...
nock('https://api-s.sandbox.paypal.com')
  ...
  location: 'https://api-s.sandbox.paypal.com/v1/invoicing/invoices/INV2-7NKZ-2GYF-6HY6-ZVZ6',
  'content-type': 'application/json',
  'content-length': '1045' });
...
nock('https://api-s.sandbox.paypal.com')
  ...
  date: 'Tue, 02 Sep 2014 14:47:20 GMT',
  location: 'https://api-s.sandbox.paypal.com/v1/invoicing/invoices/INV2-WNVY-RKWC-46V4-2KJV',
  'content-type': 'application/json',
  'content-length': '1045' });
