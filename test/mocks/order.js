...
nock('https://api-s.sandbox.paypal.com')
  ...
  .reply(201, {"id":"PAY-0MW184453U444280BKP2MJJQ","create_time":"2014-08-20T15:54:14Z","update_time":"2014-08-20T15:54:14Z","state":"created","intent":"order","payer":{"payment_method":"paypal","payer_info":{"shipping_address":{}}},"transactions":[{"amount":{"total":"10.00","currency":"USD","details":{"subtotal":"10.00"}},"description":"This is the payment description.","item_list":{"items":[{"name":"item","sku":"item","price":"10.00","currency":"USD","quantity":"1"}]}}],"links":[{"href":"https://api-s.sandbox.paypal.com/v1/payments/payment/PAY-0MW184453U444280BKP2MJJQ","rel":"self","method":"GET"},{"href":"https://www.sandbox.paypal.com/cgi-bin/webscr?cmd=_express-checkout&token=EC-7M591599VX796000M","rel":"approval_url","method":"REDIRECT"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/payment/PAY-0MW184453U444280BKP2MJJQ/execute","rel":"execute","method":"POST"}]}, { server: 'Apache-Coyote/1.1',
...
nock('https://api-s.sandbox.paypal.com')
  ...
  .reply(200, {"id":"O-1PL20702WE6290838","create_time":"2014-08-19T22:34:25Z","update_time":"2014-08-19T23:11:06Z","state":"voided","amount":{"total":"1.00","currency":"USD","details":{"subtotal":"1.00"}},"parent_payment":"PAY-7WR04190AJ956011VKPZ5B4I","links":[{"href":"https://api-s.sandbox.paypal.com/v1/payments/orders/O-1PL20702WE6290838","rel":"self","method":"GET"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/payment/PAY-7WR04190AJ956011VKPZ5B4I","rel":"parent_payment","method":"GET"}]}, { server: 'Apache-Coyote/1.1',
...
nock('https://api-s.sandbox.paypal.com')
  .post('/v1/payments/payment/', {"intent":"order","payer":{"payment_method":"paypal"},"redirect_urls":{"return_url":"http://return.url","cancel_url":"http://cancel.url"},"transactions":[{"item_list":{"items":[{"name":"item","sku":"item","price":"10.00","currency":"USD","quantity":1}]},"amount":{"currency":"USD","total":"10.00"},"description":"This is the payment description."}]})
  .reply(201, {"id":"PAY-2EN83476UG8507516KP2MGQA","create_time":"2014-08-20T15:48:16Z","update_time":"2014-08-20T15:48:16Z","state":"created","intent":"order","payer":{"payment_method":"paypal","payer_info":{"shipping_address":{}}},"transactions":[{"amount":{"total":"10.00","currency":"USD","details":{"subtotal":"10.00"}},"description":"This is the payment description.","item_list":{"items":[{"name":"item","sku":"item","price":"10.00","currency":"USD","quantity":"1"}]}}],"links":[{"href":"https://api-s.sandbox.paypal.com/v1/payments/payment/PAY-2EN83476UG8507516KP2MGQA","rel":"self","method":"GET"},{"href":"https://www.sandbox.paypal.com/cgi-bin/webscr?cmd=_express-checkout&token=EC-1K077416G88047733","rel":"approval_url","method":"REDIRECT"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/payment/PAY-2EN83476UG8507516KP2MGQA/execute","rel":"execute","method":"POST"}]}, { server: 'Apache-Coyote/1.1',
...
nock('https://api-s.sandbox.paypal.com')
  .post('/v1/payments/payment/', {"intent":"order","payer":{"payment_method":"paypal"},"redirect_urls":{"return_url":"http://return.url","cancel_url":"http://cancel.url"},"transactions":[{"item_list":{"items":[{"name":"item","sku":"item","price":"10.00","currency":"USD","quantity":1}]},"amount":{"currency":"USD","total":"10.00"},"description":"This is the payment description."}]})
  .reply(201, {"id":"PAY-3VH36914KK0714333KP2MGQQ","create_time":"2014-08-20T15:48:18Z","update_time":"2014-08-20T15:48:18Z","state":"created","intent":"order","payer":{"payment_method":"paypal","payer_info":{"shipping_address":{}}},"transactions":[{"amount":{"total":"10.00","currency":"USD","details":{"subtotal":"10.00"}},"description":"This is the payment description.","item_list":{"items":[{"name":"item","sku":"item","price":"10.00","currency":"USD","quantity":"1"}]}}],"links":[{"href":"https://api-s.sandbox.paypal.com/v1/payments/payment/PAY-3VH36914KK0714333KP2MGQQ","rel":"self","method":"GET"},{"href":"https://www.sandbox.paypal.com/cgi-bin/webscr?cmd=_express-checkout&token=EC-0J858360BN8789936","rel":"approval_url","method":"REDIRECT"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/payment/PAY-3VH36914KK0714333KP2MGQQ/execute","rel":"execute","method":"POST"}]}, { server: 'Apache-Coyote/1.1',
  proxy_server_info: 'host=slcsbjava4.slc.paypal.com;threadId=636',
...
nock('https://api-s.sandbox.paypal.com')
  ...
  .reply(200, {"id":"26Y928264E6779523","create_time":"2014-08-20T17:58:34Z","update_time":"2014-08-20T17:58:34Z","amount":{"total":"0.20","currency":"USD"},"state":"authorized","parent_payment":"PAY-4NV23757M9828530DKP2N7XI","links":[{"href":"https://api-s.sandbox.paypal.com/v1/payments/orders/O-1EW733634T317614V","rel":"self","method":"GET"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/authorization/26Y928264E6779523/reauthorize","rel":"reauthorize","method":"POST"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/authorization/26Y928264E6779523","rel":"self","method":"GET"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/authorization/26Y928264E6779523/capture","rel":"capture","method":"POST"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/authorization/26Y928264E6779523/void","rel":"void","method":"POST"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/payment/PAY-4NV23757M9828530DKP2N7XI","rel":"parent_payment","method":"GET"}]}, { server: 'Apache-Coyote/1.1',
  proxy_server_info: 'host=slcsbjava2.slc.paypal.com;threadId=665',
...
nock('https://api-s.sandbox.paypal.com')
  ...
  .reply(200, {"id":"39802600CL031140H","create_time":"2014-08-20T20:15:10Z","update_time":"2014-08-20T20:15:11Z","amount":{"total":"0.70","currency":"USD"},"is_final_capture":true,"state":"completed","parent_payment":"PAY-2V41623380267390HKP2QAHI","links":[{"href":"https://api-s.sandbox.paypal.com/v1/payments/capture/39802600CL031140H","rel":"self","method":"GET"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/capture/39802600CL031140H/refund","rel":"refund","method":"POST"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/orders/O-7A4605469K8426134","rel":"order","method":"GET"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/payment/PAY-2V41623380267390HKP2QAHI","rel":"parent_payment","method":"GET"}]}, { server: 'Apache-Coyote/1.1',
...
nock('https://api-s.sandbox.paypal.com')
  .post('/v1/payments/orders/O-1PL20702WE6290838/do-void', {})
  .reply(200, {"id":"O-1PL20702WE6290838","create_time":"2014-08-20T20:19:13Z","update_time":"2014-08-20T20:21:23Z","state":"voided","amount":{"total":"1.00","currency":"USD","details":{"subtotal":"1.00"}},"parent_payment":"PAY-69J29134LS9140105KP2QFQI","links":[{"href":"https://api-s.sandbox.paypal.com/v1/payments/orders/O-6UR85601HU7666938","rel":"self","method":"GET"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/payment/PAY-69J29134LS9140105KP2QFQI","rel":"parent_payment","method":"GET"}]}, { server: 'Apache-Coyote/1.1',
