...
nock('https://api.sandbox.paypal.com')
  .patch('/v1/payments/billing-agreements/I-08413VDRU6DE', {"name":"Fast Speed Agreement","description":"Agreement for Fast Speed Plan","start_date":"2018-02-19T00:37:04Z","plan":{"id":"P-8M239038M4250351NECAMIPI"},"payer":{"payment_method":"paypal"},"shipping_address":{"line1":"StayBr111idge Suites","line2":"Cro12ok Street","city":"San Jose","state":"CA","postal_code":"95112","country_code":"US"}})
  .reply(201, {"name":"Fast Speed Agreement","description":"Agreement for Fast Speed Plan","plan":{"id":"P-8M239038M4250351NECAMIPI","state":"ACTIVE","name":"Testing1-Regular1","description":"Create Plan for Regular","type":"INFINITE","payment_definitions":[{"id":"PD-6NM64917YN7765425ECAMIPI","name":"Regular 1","type":"REGULAR","frequency":"Month","amount":{"currency":"USD","value":"100"},"charge_models":[{"id":"CHM-0KE608780B2534216ECAMIPI","type":"TAX","amount":{"currency":"USD","value":"20"}},{"id":"CHM-5LV43906LJ307104DECAMIPI","type":"SHIPPING","amount":{"currency":"USD","value":"10.6"}}],"cycles":"0","frequency_interval":"1"},{"id":"PD-6C822850FP2569353ECAMIPI","name":"Trial 1","type":"TRIAL","frequency":"Month","amount":{"currency":"USD","value":"20"},"charge_models":[{"id":"CHM-2B6251795H312091PECAMIPI","type":"TAX","amount":{"currency":"USD","value":"20"}},{"id":"CHM-7HY62822F8753893WECAMIPI","type":"SHIPPING","amount":{"currency":"USD","value":"10.6"}}],"cycles":"4","frequency_interval":"1"}],"merchant_preferences":{"setup_fee":{"currency":"USD","value":"25"},"max_fail_attempts":"1","return_url":"http://www.success.com","cancel_url":"http://www.cancel.com","auto_bill_amount":"YES","initial_fail_amount_action":"CONTINUE"}},"links":[{"href":"https://www.sandbox.paypal.com/cgi-bin/webscr?cmd=_express-checkout&token=EC-28Y23504JA4250117","rel":"approval_url","method":"REDIRECT"},{"href":"https://api.sandbox.paypal.com/v1/payments/billing-agreements/EC-28Y23504JA4250117/agreement-execute","rel":"execute","method":"POST"}],"start_date":"2018-02-19T00:37:04Z"}, { server: 'Apache-Coyote/1.1',
  proxy_server_info: 'host=slcsbjava2.slc.paypal.com;threadId=10599',
  'paypal-debug-id': '2c4c1b090bc6d',
  server_info: 'paymentsplatformserv:v1.payments.billing-agreements&CalThreadId=212&TopLevelTxnStartTime=1472080c6a4&Host=slcsbjm1.slc.paypal.com&pid=17780',
...
nock('https://api.sandbox.paypal.com')
  .post('/v1/payments/billing-agreements/', {"name":"Fast Speed Agreement","description":"Agreement for Fast Speed Plan","start_date":"2018-02-19T00:37:04Z","plan":{"id":"P-8RN28686DX2447226YXOCQPA"},"payer":{"payment_method":"paypal"},"shipping_address":{"line1":"StayBr111idge Suites","line2":"Cro12ok Street","city":"San Jose","state":"CA","postal_code":"95112","country_code":"US"}})
...
nock('https://api.sandbox.paypal.com')
  .post('/v1/payments/billing-agreements/', {"name":"Fast Speed Agreement","description":"Agreement for Fast Speed Plan","start_date":"2018-02-19T00:37:04Z","plan":{"id":"P-12U98928TT9129128ECALAJY"},"payer":{"payment_method":"paypal"},"shipping_address":{"line1":"StayBr111idge Suites","line2":"Cro12ok Street","city":"San Jose","state":"CA","postal_code":"95112","country_code":"US"}})
...
nock('https://api.sandbox.paypal.com')
  .post('/v1/payments/billing-agreements/', {"name":"Fast Speed Agreement","description":"Agreement for Fast Speed Plan","start_date":"2018-02-19T00:37:04Z","plan":{"id":"P-2JX43094YJ325493D5EMHPFA"},"payer":{"payment_method":"paypal"},"shipping_address":{"line1":"StayBr111idge Suites","line2":"Cro12ok Street","city":"San Jose","state":"CA","postal_code":"95112","country_code":"US"}})
...
nock('https://api.sandbox.paypal.com')
  .post('/v1/payments/billing-agreements/', {"name":"Fast Speed Agreement","description":"Agreement for Fast Speed Plan","start_date":"2018-02-19T00:37:04Z","plan":{"id":"P-1YX0764912529121J5EMIBEQ"},"payer":{"payment_method":"paypal"},"shipping_address":{"line1":"StayBr111idge Suites","line2":"Cro12ok Street","city":"San Jose","state":"CA","postal_code":"95112","country_code":"US"}})
...
nock('https://api.sandbox.paypal.com')
  .post('/v1/payments/billing-plans/', {"description":"Invalid JSON Handling Plan","name":"Testing1-HandleInvalidJSON","merchant_preferences":{"auto_bill_amount":"yes","cancel_url":"http://www.cancel.com","initial_fail_amount_action":"continue","max_fail_attempts":"1","return_url":"http://www.success.com","setup_fee":{"currency":"USD","value":"25"}},"payment_definitions":[{"amount":{"currency":"USD","value":"100"},"charge_models":[{"amount":{"currency":"USD","value":"10.60"},"type":"SHIPPING"},{"amount":{"currency":"USD","value":"20"},"type":"TAX"}],"cycles":"0","frequency":"MONTH","frequency_interval":"1","name":"Regular 1","type":"REGULAR"}],"type":"INFINITE"})
  .reply(201, {"id":"P-Invalid-JSON","state":"CREATED","name":"Testing1-HandleInvalidJSON","description":"Create Plan for Regular","type":"INFINITE","payee":{"merchant_id":"1861094158886678455"},"payment_definitions":[{"id":"PD-1CY27554T0541600R5EMIBEQ","name":"Regular 1","type":"REGULAR","frequency":"Month","amount":{"currency":"USD","value":"100"},"charge_models":[{"id":"CHM-9DU94426GV805500C5EMIBEQ","type":"SHIPPING","amount":{"currency":"USD","value":"10.6"}},{"id":"CHM-6EN78266AM85162125EMIBEQ","type":"TAX","amount":{"currency":"USD","value":"20"}}],"cycles":"0","frequency_interval":"1"},{"id":"PD-382219814A915323K5EMIBEQ","name":"Trial 1","type":"TRIAL","frequency":"Month","amount":{"currency":"USD","value":"20"},"charge_models":[{"id":"CHM-9DB35333XA08089235EMIBEQ","type":"SHIPPING","amount":{"currency":"USD","value":"10.6"}},{"id":"CHM-5171350835213344L5EMIBEQ","type":"TAX","amount":{"currency":"USD","value":"20"}}],"cycles":"4","frequency_interval":"1"}],"merchant_preferences":{"setup_fee":{"currency":"USD","value":"25"},"max_fail_attempts":"1","return_url":"http://www.success.com","cancel_url":"http://www.cancel.com","auto_bill_amount":"YES","initial_fail_amount_action":"CONTINUE"},"create_time":"2014-08-18T12:30:02.898Z","update_time":"2014-08-18T12:30:02.898Z","links":[{"href":"https://api.sandbox.paypal.com/v1/payments/billing-plans/P-1YX0764912529121J5EMIBEQ","rel":"self","method":"GET"}]}, { server: 'Apache-Coyote/1.1',
  proxy_server_info: 'host=slcsbjava4.slc.paypal.com;threadId=36148',
  'paypal-debug-id': '5647c37db935f',
  server_info: 'paymentsplatformserv:v1.payments.billing-plans&CalThreadId=212&TopLevelTxnStartTime=147e918808a&Host=slcsbjm3.slc.paypal.com&pid=25126',
  'content-language': '*',
...
nock('https://api.sandbox.paypal.com')
  .patch('/v1/payments/billing-plans/P-Invalid-JSON', [{"op":"replace","path":"/","value":{"state":"ACTIVE"}}])
  .reply(200, "	  	", { server: 'Apache-Coyote/1.1',
  proxy_server_info: 'host=slcsbjava1.slc.paypal.com;threadId=262',
  'paypal-debug-id': '1187c8bab8de0',
  server_info: 'paymentsplatformserv:v1.payments.billing-plans&CalThreadId=305&TopLevelTxnStartTime=147e91882b9&Host=slcsbjm2.slc.paypal.com&pid=26669',
