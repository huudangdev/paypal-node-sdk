...
nock('https://api-s.sandbox.paypal.com')
  ...
  .reply(201, {"id":"0LS3308554161733N","url":"https://www.yeowza.com/ppwebhook","event_types":[{"name":"PAYMENT.AUTHORIZATION.CREATED","description":"A payment authorization was created"},{"name":"PAYMENT.AUTHORIZATION.VOIDED","description":"A payment authorization was voided"}],"links":[{"href":"https://api-s.sandbox.paypal.com/v1/notifications/webhooks/0LS3308554161733N","rel":"self","method":"GET"},{"href":"https://api-s.sandbox.paypal.com/v1/notifications/webhooks/0LS3308554161733N","rel":"update","method":"PATCH"},{"href":"https://api-s.sandbox.paypal.com/v1/notifications/webhooks/0LS3308554161733N","rel":"delete","method":"DELETE"}]}, { server: 'Apache-Coyote/1.1',
...
nock('https://api-s.sandbox.paypal.com')
  ...
  .reply(200, {"id":"0LS3308554161733N","url":"https://www.yeowza.com/ppwebhook","event_types":[{"name":"PAYMENT.AUTHORIZATION.CREATED","description":"A payment authorization was created"},{"name":"PAYMENT.AUTHORIZATION.VOIDED","description":"A payment authorization was voided"}],"links":[{"href":"https://api-s.sandbox.paypal.com/v1/notifications/webhooks/0LS3308554161733N","rel":"self","method":"GET"},{"href":"https://api-s.sandbox.paypal.com/v1/notifications/webhooks/0LS3308554161733N","rel":"update","method":"PATCH"},{"href":"https://api-s.sandbox.paypal.com/v1/notifications/webhooks/0LS3308554161733N","rel":"delete","method":"DELETE"}]}, { server: 'Apache-Coyote/1.1',
  proxy_server_info: 'host=slcsbjava3.slc.paypal.com;threadId=243',
...
nock('https://api-s.sandbox.paypal.com')
  .post('/v1/notifications/webhooks/', {"url":"https://www.yeowza.com/ppwebhook","event_types":[{"name":"PAYMENT.AUTHORIZATION.CREATED"},{"name":"PAYMENT.AUTHORIZATION.VOIDED"}]})
  .reply(201, {"id":"6HY79521VR978045E","url":"https://www.yeowza.com/ppwebhook","event_types":[{"name":"PAYMENT.AUTHORIZATION.CREATED","description":"A payment authorization was created"},{"name":"PAYMENT.AUTHORIZATION.VOIDED","description":"A payment authorization was voided"}],"links":[{"href":"https://api-s.sandbox.paypal.com/v1/notifications/webhooks/6HY79521VR978045E","rel":"self","method":"GET"},{"href":"https://api-s.sandbox.paypal.com/v1/notifications/webhooks/6HY79521VR978045E","rel":"update","method":"PATCH"},{"href":"https://api-s.sandbox.paypal.com/v1/notifications/webhooks/6HY79521VR978045E","rel":"delete","method":"DELETE"}]}, { server: 'Apache-Coyote/1.1',
...
nock('https://api-s.sandbox.paypal.com')
  ...
  .reply(200, {"events":[{"id":"WH-1S115631EN580315E-9KH94552VF7913711","create_time":"2014-10-20T12:04:32Z","resource_type":"authorization","event_type":"PAYMENT.AUTHORIZATION.CREATED","summary":"A successful payment authorization was created for 1.00 USD","resource":{"amount":{"total":"1.00","currency":"USD","details":{"subtotal":"1.00"}},"id":"76V79459UM225560P","parent_payment":"PAY-1KA56302VE598851HKRCPTUA","update_time":"2014-10-20T12:03:24Z","state":"authorized","payment_mode":"INSTANT_TRANSFER","create_time":"2014-10-20T12:02:24Z","links":[{"href":"https://api-s.sandbox.paypal.com/v1/payments/authorization/76V79459UM225560P","rel":"self","method":"GET"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/authorization/76V79459UM225560P/capture","rel":"capture","method":"POST"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/authorization/76V79459UM225560P/void","rel":"void","method":"POST"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/authorization/76V79459UM225560P/reauthorize","rel":"reauthorize","method":"POST"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/payment/PAY-1KA56302VE598851HKRCPTUA","rel":"parent_payment","method":"GET"}],"valid_until":"2014-11-18T12:02:24Z","protection_eligibility_type":"ITEM_NOT_RECEIVED_ELIGIBLE,UNAUTHORIZED_PAYMENT_ELIGIBLE","protection_eligibility":"ELIGIBLE"},"links":[{"href":"https://api-s.sandbox.paypal.com/v1/notifications/webhooks-events/WH-1S115631EN580315E-9KH94552VF7913711","rel":"self","method":"GET"},{"href":"https://api-s.sandbox.paypal.com/v1/notifications/webhooks-events/WH-1S115631EN580315E-9KH94552VF7913711/resend","rel":"resend","method":"POST"}]},{"id":"WH-9CX24309MH241002A-02146673H3282292X","create_time":"2014-10-20T11:42:25Z","resource_type":"authorization","event_type":"PAYMENT.AUTHORIZATION.CREATED","summary":"A successful payment authorization was created for 15.00 USD","resource":{"amount":{"total":"15.00","currency":"USD","details":{"subtotal":"15.00"}},"id":"1DK351744D8079127","parent_payment":"PAY-55179425P6892414NKRCPI7I","update_time":"2014-10-20T11:41:14Z","state":"authorized","payment_mode":"INSTANT_TRANSFER","create_time":"2014-10-20T11:39:41Z","links":[{"href":"https://api-s.sandbox.paypal.com/v1/payments/authorization/1DK351744D8079127","rel":"self","method":"GET"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/authorization/1DK351744D8079127/capture","rel":"capture","method":"POST"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/authorization/1DK351744D8079127/void","rel":"void","method":"POST"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/authorization/1DK351744D8079127/reauthorize","rel":"reauthorize","method":"POST"},{"href":"https://api-s.sandbox.paypal.com/v1/payments/payment/PAY-55179425P6892414NKRCPI7I","rel":"parent_payment","method":"GET"}],"valid_until":"2014-11-18T11:39:41Z","protection_eligibility_type":"ITEM_NOT_RECEIVED_ELIGIBLE,UNAUTHORIZED_PAYMENT_ELIGIBLE","protection_eligibility":"ELIGIBLE"},"links":[{"href":"https://api-s.sandbox.paypal.com/v1/notifications/webhooks-events/WH-9CX24309MH241002A-02146673H3282292X","rel":"self","method":"GET"},{"href":"https://api-s.sandbox.paypal.com/v1/notifications/webhooks-events/WH-9CX24309MH241002A-02146673H3282292X/resend","rel":"resend","method":"POST"}]}],"count":2}, { server: 'Apache-Coyote/1.1',
