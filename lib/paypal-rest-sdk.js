...
module.exports = function () {
    ...
    function logout_url(data, config) {
        ...
        var url = config.logout_url ||
          'https://www.' + get_default_endpoint(config.mode) + '/webapps/auth/protocol/openidconnect/v1/endsession' || default_options.logout_url;
    ...
    return {
        ...
        billing_plans: {
            ...
            list: function (config, cb) {
                executeHttp('GET', '/v1/payments/billing-plans/', {}, config, cb);
            },
            replace: function (plan_id, data, config, cb) {
        ...
        billing_agreements: {
            ...
            replace: function (agreement_id, data, config, cb) {
                executeHttp('PATCH', '/v1/payments/billing-agreements/' + agreement_id, {}, config, cb);
            },
            execute: function (agreement_id, data, config, cb) {
                executeHttp('POST', '/v1/payments/billing-agreements/' + agreement_id + '/agreement-execute', data, config, cb);
            },
            ...
            re_activate: function (agreement_id, data, config, cb) {
            ...
            search_transactions: function (agreement_id, data, config, cb) {
                executeHttp('GET', '/v1/payments/billing-agreements/' + agreement_id + '/transactions', data, config, cb);
            }
        },
        credit_card: {
            create: function (data, config, cb) {
