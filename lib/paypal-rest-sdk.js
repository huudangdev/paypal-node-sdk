...
module.exports = function () {
    ...
    function generate_token(config, cb) {
        ...
        var http_options = {
            ...
            host: get_default_api_endpoint(config.mode) || config.host,
    ...
    function authorize_url(data, config) {
        ...
        var url = config.authorize_url || 
            'https://www.' + get_default_endpoint(config.mode) + '/webapps/auth/protocol/openidconnect/v1/authorize' || 
            default_options.authorize_url;
    ...
    function logout_url(data, config) {
        ...
        var url = config.logout_url ||
          'https://www.' + get_default_endpoint(config.mode) + '/webapps/auth/protocol/openidconnect/v1/endsession' || 
          default_options.logout_url;
