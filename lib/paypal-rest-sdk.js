...
module.exports = function () {
    ...
    function authorize_url(data, config) {
        ...
        data['client_id']     = data['client_id'] || get_openid_client_id(config);
        data['scope']         = data['scope'] || 'openid';
        data['response_type'] = data['response_type'] || 'code';
        data['redirect_uri']  = data['redirect_uri'] || get_openid_redirect_uri(config);
    ...
    function tokeninfo_request(data, config, cb){
        ...
        data['client_id']     = data['client_id'] || get_openid_client_id(config);
        data['client_secret'] = data['client_secret'] || get_openid_client_secret(config);
