...
module.exports = function () {
    ...
    function invoke(http_scheme, http_method, path, data, http_options_param, cb) {
        ...
        if (http_options_param) {
            ...
            if (http_method !== 'GET' && http_method !== 'DELETE' && !http_options.headers['PayPal-Request-Id']) {
    ...
    return {
        ...
        authorization: {
            get: function (authorization_id, config_opts, cb) {
                executeHttp('https', 'GET', '/v1/payments/authorization/' + authorization_id, {}, config_opts, cb);
            },
            capture: function (authorization_id, data, config_opts, cb) {
                executeHttp('https', 'POST', '/v1/payments/authorization/' + authorization_id + '/capture', data, config_opts, cb);
            },
            void: function (authorization_id, config_opts, cb) {
                executeHttp('https', 'POST', '/v1/payments/authorization/' + authorization_id + '/void', {}, config_opts, cb);
            }
        },
        capture: {
            refund: function (capture_id, data, config_opts, cb) {
                executeHttp('https', 'POST', '/v1/payments/capture/' + capture_id + '/refund', data, config_opts, cb);
            },
            get: function (capture_id, config_opts, cb) {
                executeHttp('https', 'GET', '/v1/payments/capture/' + capture_id, {}, config_opts, cb);
            }
        },
        credit_card: {
            create: function (data, config_opts, cb) {
            ...
            delete: function (credit_card_id, config_opts, cb) {
                executeHttp('https', 'DELETE', '/v1/vault/credit-card/' + credit_card_id, {}, config_opts, cb);
            }
        },
        openid_connect: {
            tokeninfo: {
