...
var authorize_url = exports.authorize_url = function authorize_url(data, config) {
...
var logout_url = exports.logout_url = function logout_url(data, config) {
    config = config || configuration.default_options;
    data   = data || {};
...
var tokenInfoRequest = exports.tokenInfoRequest = function tokenInfoRequest(data, config, cb) {
...
var userInfoRequest = exports.userInfoRequest = function userInfoRequest(data, config, cb) {
    if (typeof config === 'function') {
        cb = config;
        config = configuration.default_options;
    } else if (!config) {
