...
var userAgent = exports.userAgent = 'PayPalSDK/PayPal-node-SDK ' + sdkVersion + ' (platform=node; platform-ver=' + process.version + '-' + process.arch + '-' + process.platform  + '; crypto-lib-ver=OpenSSL ' + process.versions.openssl + ')';
